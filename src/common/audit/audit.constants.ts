export const AUDIT_ACTIONS = {
  ...
  schoolRegistered: 'school.registered',
  roleCreated: 'authorization.role_created',
  roleUpdated: 'authorization.role_updated',
  permissionCreated: 'authorization.permission_created',
  permissionUpdated: 'authorization.permission_updated',
